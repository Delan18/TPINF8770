...
if __name__ == "__main__":
    ...
    with open("data/text_structured/accumulation-accounts-2008-2023-provisional.csv", "r", encoding="utf-8") as f:
        text = f.read()
    ...
    with open("data/text_code/code2.html", 'r', encoding='utf-8', errors='ignore') as file:
    ...
    with open("data/text_natural/text_natural_1.txt", 'r', encoding='utf-8', errors='ignore') as file:
